...
public class Applipatent {
    ...
    public Applipatent(int id, Date time, String patentname, String applicant, String inventor, String summary, String category, String ZLnum, String CNnum, String status) {
        this.id = id;
        this.time = time;
