...
public class Applipaper {
    ...
    public Applipaper(int id, Date time, String chname, String enname, String author, String subject, String publication, String publevel, String pubattributes, String CNnum, String ISSNnum, int count, String pagenum, String remark, String status) {
        this.id = id;
        this.time = time;
        this.chname = chname;
        this.enname = enname;
