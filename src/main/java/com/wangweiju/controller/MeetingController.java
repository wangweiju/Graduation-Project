...
import com.wangweiju.mapper.MeetingMapper;
...
public class MeetingController {
    ...
    public String queryMeetingBySubjectList(Model model, @RequestParam(required = false,defaultValue="1",value="pageNum")Integer pageNum,
        ...
        try {
            List<Meeting> meetingList = meetingMapper.queryMeetingBySubjectList(subject);
            System.out.println("分页数据：" + meetingList);
            //3.使用PageInfo包装查询后的结果,5是连续显示的条数,结果list类型是Page<E>
            PageInfo<Meeting> pageInfo = new PageInfo<Meeting>(meetingList, pageSize);
